...
if (fs.existsSync(initPath+'/config/config.json')) {
	...
	var { bot_nickname, bot_api_key, bot_port_web, bot_port_com, bot_shell_whitelist, discord_token_bot, discord_token_self, bot_logo_long, bot_logo_square, bot_info_website, bot_info_copyright, bot_motd_disable, web_title, web_favicon, dropbox_token } = config;
	module.exports = {
