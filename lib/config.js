...
if (fs.existsSync(initPath+'/config/config.json')) {
	...
	// dropbox = node_dropbox.api('unSz38AHAhAAAAAAAAAADzy4sfguOaNpwsUa7mOYmewLSe-oOV3_1YJ3JpMBB4X8');
	// console.log('Testing Dropbox write file...');
	// var content = encodeURIComponent("test");
	// dropbox.createFile('test.json', content, function(err, res, body) {
		// if(!err) {
			// console.log(body);
			// console.log('Sucessfully wrote /test.json to DropBox!'.green);
		// } else {
			// console.log(err);
		// }
	// });
